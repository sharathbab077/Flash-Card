<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="flashcard.WebForm1" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<asp:TextBox ID="user" placeholder="Enter username" class="form-control" runat="server"></asp:TextBox>
		<label for="Password">Password</label>
		<asp:TextBox ID="password" placeholder="Enter Password" class="form-control" runat="server"></asp:TextBox>
		
		</div>
		<div class="container">
		<div class="row">
		<div class="col-md-4">
		<asp:Button ID="adduser" type="submit" class="btn btn-primary" runat="server" Text="Login" OnClick="adduser_Click"  />
		</div> 
		<div class="col-md-4">
